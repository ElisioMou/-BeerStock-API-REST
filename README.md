...
Vamos aprender a testar, unitariamente, uma API REST para o gerenciamento de estoques de cerveja, desenvolver testes unitários para validar o nosso sistema de gerenciamento de estoques de cerveja, e também apresentar os principais conceitos e vantagens de criar testes unitários com JUnit e Mockito. Além disso, desenvolver funcionalidades da nossa API através da prática do TDD.
